...
def test_length(input_value):
    """ Tests whether a string has fewer than 10 words and fewer than 50 chars.
        1. Used an assert statement to check the given string has fewer than 10 words
        2. Used an assert statement to check the given string has fewer than 50 chars
    Args:
...
def test_struc(input_value):
    """ Tests whether a string begins with a capital letter and ends with a period.
        1. Used an assert statement to check the given string begins with a capital letter
        2. Used an assert statement to check the given string end with a period ('.')
    Args:
      input_value: a function that returns a string, which can be configured
                   in the input_value() function
    """   
